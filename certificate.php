   ...
   .bottom-logo{
    ...
    <div class="certificate">
        ...
        <div class="content">
            ...
            <p>This is to certify that <span id="nameField"><strong><?php echo htmlspecialchars($name); ?></strong> is a Grade <strong><?php echo htmlspecialchars($level); ?></strong> graduate of this institution for
                the school year <strong><?php echo htmlspecialchars($acadyear); ?></strong>.</span></p>
            <p>It is certified that <strong><?php echo htmlspecialchars($category); ?></strong> character is categorized as:</p>
            
            <div class="checkbox">
                <input type="checkbox" id="a">
                <label for="checkbox">Category A: The student is of good moral character and has never been
                    subjected to administrative proceedings for violation/s of the school policies.</label>
            </div>
            <div class="checkbox">
                <input type="checkbox" id="b">
                <label for="checkbox">Category B: The student is generally a good moral character but was subjected
                    to administrative proceedings for less grave violation/s of the school policies. With
                    interventions given by <strong><?php echo htmlspecialchars($category); ?></strong> class adviser, the student improved in<strong><?php echo htmlspecialchars($category); ?> </strong>  behavior.
                </label>
            </div>
            <div class="checkbox">
            ...
            <p>This certification is issued to the above-mentioned student for enrollment purposes.</p>
            <p>Issued this <strong id="dateAndTime"><?php echo $formattedDate; ?></strong> at <strong><?php echo htmlspecialchars($school); ?></strong>, <strong><?php echo htmlspecialchars($place); ?></strong>.</p>
        </div>
