            ...
            <?php
                ...
                $sql = "INSERT INTO record (adname, name, level, lrn, birthdate, birthplace, father, contact1, occupation1, mother, contact2, occupation2, language, earlydisease, hobby, subeasy, age, height, weight,seriousaccident, specialtalent, subdiff, elem, highschool, college)
                 VALUES ('$adname', '$name', '$level', '$lrn', '$birthdate', '$birthplace', '$father', '$contact1', '$occupation1', '$mother', '$contact2', '$occupation2', '$language', '$earlydisease', '$hobby', '$subeasy', '$age', '$height', '$weight', '$seriousaccident', '$specialtalent', '$subdiff', '$elem', '$highschool', '$college')";
